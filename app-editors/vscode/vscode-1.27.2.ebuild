...
SRC_URI="
	...
	https://registry.npmjs.org/gc-signals/-/gc-signals-0.0.1.tgz -> vscodedep-gc-signals-${GC_SIGNALS_V}.tar.gz
	...
	https://registry.npmjs.org/native-watchdog/-/native-watchdog-0.3.0.tgz -> vscodedep-native-watchdog-${NATIVE_WATCHDOG_V}.tar.gz
	https://registry.npmjs.org/node-pty/-/node-pty-0.7.6.tgz -> vscodedep-node-pty-${NODE_PTY_V}.tar.gz
	https://registry.npmjs.org/oniguruma/-/oniguruma-7.0.2.tgz -> vscodedep-oniguruma-${ONIGURUMA_V}.tar.gz
	https://registry.npmjs.org/spdlog/-/spdlog-0.7.1.tgz -> vscodedep-spdlog-${SPDLOG_V}.tar.gz
	https://registry.npmjs.org/vscode-nsfw/-/vscode-nsfw-1.0.17.tgz -> vscodedep-vscode-nsfw-${VSCODE_NSFW_V}.tar.gz
"
