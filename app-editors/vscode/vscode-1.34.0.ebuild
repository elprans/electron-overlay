...
SRC_URI="
	...
	https://registry.npmjs.org/node-pty/-/node-pty-0.8.1.tgz -> vscodedep-node-pty-${NODE_PTY_V}.tar.gz
	https://registry.npmjs.org/oniguruma/-/oniguruma-7.1.0.tgz -> vscodedep-oniguruma-${ONIGURUMA_V}.tar.gz
