...
SRC_URI="
	...
	mirror://npm/@vscode/sqlite3/-/sqlite3-4.0.12.tgz -> vscodedep-vscode--sqlite3-${VSCODE__SQLITE3_V}.tar.gz
	mirror://npm/keytar/-/keytar-7.2.0.tgz -> vscodedep-keytar-${KEYTAR_V}.tar.gz
	mirror://npm/native-is-elevated/-/native-is-elevated-0.4.3.tgz -> vscodedep-native-is-elevated-${NATIVE_IS_ELEVATED_V}.tar.gz
	mirror://npm/native-keymap/-/native-keymap-3.0.2.tgz -> vscodedep-native-keymap-${NATIVE_KEYMAP_V}.tar.gz
	mirror://npm/native-watchdog/-/native-watchdog-1.3.0.tgz -> vscodedep-native-watchdog-${NATIVE_WATCHDOG_V}.tar.gz
	mirror://npm/node-pty/-/node-pty-0.11.0-beta11.tgz -> vscodedep-node-pty-${NODE_PTY_V}.tar.gz
	mirror://npm/spdlog/-/spdlog-0.13.6.tgz -> vscodedep-spdlog-${SPDLOG_V}.tar.gz
	mirror://npm/vscode-nsfw/-/vscode-nsfw-2.1.8.tgz -> vscodedep-vscode-nsfw-${VSCODE_NSFW_V}.tar.gz
"
