...
NATIVE_KEYMAP_V=2.1.1
NATIVE_WATCHDOG_V=1.3.0
NODE_PTY_V=0.10.0-beta4
ONIGURUMA_V=7.2.1
SPDLOG_V=0.11.1
VSCODE_NSFW_V=1.2.8
...
SRC_URI="
	...
	https://registry.npmjs.org/native-keymap/-/native-keymap-2.1.1.tgz -> vscodedep-native-keymap-${NATIVE_KEYMAP_V}.tar.gz
	https://registry.npmjs.org/native-watchdog/-/native-watchdog-1.3.0.tgz -> vscodedep-native-watchdog-${NATIVE_WATCHDOG_V}.tar.gz
	https://registry.npmjs.org/node-pty/-/node-pty-0.10.0-beta4.tgz -> vscodedep-node-pty-${NODE_PTY_V}.tar.gz
