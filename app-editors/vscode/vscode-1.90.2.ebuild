...
SRC_URI="
	...
	https://registry.npmjs.org/kerberos/-/kerberos-2.1.1-alpha.0.tgz -> vscodedep-kerberos-${KERBEROS_V}.tar.gz
	...
	https://registry.npmjs.org/node-pty/-/node-pty-1.1.0-beta11.tgz -> vscodedep-node-pty-${NODE_PTY_V}.tar.gz
"
