...
GC_SIGNALS_V=0.0.2
KEYTAR_V=4.2.1
NATIVE_IS_ELEVATED_V=0.2.1
NATIVE_KEYMAP_V=1.2.5
NATIVE_WATCHDOG_V=1.0.0
NODE_PTY_V=0.9.0-beta13
ONIGURUMA_V=7.2.0
SPDLOG_V=0.8.1
VSCODE_NSFW_V=1.1.1
VSCODE_SQLITE3_V=4.0.7
...
SRC_URI="
	...
	https://registry.npmjs.org/gc-signals/-/gc-signals-0.0.2.tgz -> vscodedep-gc-signals-${GC_SIGNALS_V}.tar.gz
	https://registry.npmjs.org/keytar/-/keytar-4.2.1.tgz -> vscodedep-keytar-${KEYTAR_V}.tar.gz
	https://registry.npmjs.org/native-is-elevated/-/native-is-elevated-0.2.1.tgz -> vscodedep-native-is-elevated-${NATIVE_IS_ELEVATED_V}.tar.gz
	https://registry.npmjs.org/native-keymap/-/native-keymap-1.2.5.tgz -> vscodedep-native-keymap-${NATIVE_KEYMAP_V}.tar.gz
	https://registry.npmjs.org/native-watchdog/-/native-watchdog-1.0.0.tgz -> vscodedep-native-watchdog-${NATIVE_WATCHDOG_V}.tar.gz
	https://registry.npmjs.org/node-pty/-/node-pty-0.9.0-beta13.tgz -> vscodedep-node-pty-${NODE_PTY_V}.tar.gz
	https://registry.npmjs.org/oniguruma/-/oniguruma-7.2.0.tgz -> vscodedep-oniguruma-${ONIGURUMA_V}.tar.gz
	https://registry.npmjs.org/spdlog/-/spdlog-0.8.1.tgz -> vscodedep-spdlog-${SPDLOG_V}.tar.gz
	https://registry.npmjs.org/vscode-nsfw/-/vscode-nsfw-1.1.1.tgz -> vscodedep-vscode-nsfw-${VSCODE_NSFW_V}.tar.gz
	https://registry.npmjs.org/vscode-sqlite3/-/vscode-sqlite3-4.0.7.tgz -> vscodedep-vscode-sqlite3-${VSCODE_SQLITE3_V}.tar.gz
"
