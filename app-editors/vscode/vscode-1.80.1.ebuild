...
VSCODE__WINDOWS_MUTEX_V=0.4.4
VSCODE__WINDOWS_PROCESS_TREE_V=0.5.0
...
SRC_URI="
	...
	https://registry.npmjs.org/@vscode/windows-mutex/-/windows-mutex-0.4.4.tgz -> vscodedep-vscode--windows-mutex-${VSCODE__WINDOWS_MUTEX_V}.tar.gz
	https://registry.npmjs.org/@vscode/windows-process-tree/-/windows-process-tree-0.5.0.tgz -> vscodedep-vscode--windows-process-tree-${VSCODE__WINDOWS_PROCESS_TREE_V}.tar.gz
	...
	https://registry.npmjs.org/node-pty/-/node-pty-1.1.0-beta1.tgz -> vscodedep-node-pty-${NODE_PTY_V}.tar.gz
"
