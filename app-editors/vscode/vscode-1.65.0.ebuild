...
SRC_URI="
	...
	https://registry.npmjs.org/keytar/-/keytar-7.6.0.tgz -> vscodedep-keytar-${KEYTAR_V}.tar.gz
	...
	https://registry.npmjs.org/native-keymap/-/native-keymap-3.2.1.tgz -> vscodedep-native-keymap-${NATIVE_KEYMAP_V}.tar.gz
