...
ATOM__FUZZY_NATIVE_V=1.2.1
ATOM__NSFW_V=1.0.28
ATOM__WATCHER_V=1.3.5
ATOM_PACKAGE_MANAGER_V=2.6.2
CTAGS_V=3.1.0
FS_ADMIN_V=0.15.0
GIT_UTILS_V=5.7.1
KEYBOARD_LAYOUT_V=2.0.16
KEYTAR_V=6.0.1
NPM_V=6.14.16
NPM_LIFECYCLE_V=3.1.5
NSLOG_V=3.2.0
ONIGURUMA_V=7.2.1
PATHWATCHER_V=8.1.2
SCROLLBAR_STYLE_V=4.0.1
SPELLCHECKER_V=3.7.1
SUPERSTRING_V=2.4.4
TREE_SITTER_V=0.17.1
TREE_SITTER_BASH_V=0.16.1
TREE_SITTER_C_V=0.15.3
TREE_SITTER_CPP_V=0.15.1
TREE_SITTER_CSS_V=0.15.0
TREE_SITTER_EMBEDDED_TEMPLATE_V=0.15.2
TREE_SITTER_GO_V=0.15.1
TREE_SITTER_HTML_V=0.15.1
TREE_SITTER_JAVA_DEV_V=0.16.0-dev2
TREE_SITTER_JAVASCRIPT_V=0.15.2
TREE_SITTER_JSDOC_V=0.15.2
TREE_SITTER_JSON_V=0.15.1
TREE_SITTER_PYTHON_V=0.17.1
TREE_SITTER_REGEX_V=0.15.1
TREE_SITTER_RUBY_V=0.15.3
TREE_SITTER_TYPESCRIPT_V=0.16.3
...
SRC_URI="
	...
	mirror://npm/@atom/fuzzy-native/-/fuzzy-native-1.2.1.tgz -> atomdep-atom--fuzzy-native-${ATOM__FUZZY_NATIVE_V}.tar.gz
	mirror://npm/@atom/nsfw/-/nsfw-1.0.28.tgz -> atomdep-atom--nsfw-${ATOM__NSFW_V}.tar.gz
	mirror://npm/@atom/watcher/-/watcher-1.3.5.tgz -> atomdep-atom--watcher-${ATOM__WATCHER_V}.tar.gz
	mirror://npm/atom-package-manager/-/atom-package-manager-2.6.2.tgz -> atomdep-atom-package-manager-${ATOM_PACKAGE_MANAGER_V}.tar.gz
	mirror://npm/ctags/-/ctags-3.1.0.tgz -> atomdep-ctags-${CTAGS_V}.tar.gz
	mirror://npm/fs-admin/-/fs-admin-0.15.0.tgz -> atomdep-fs-admin-${FS_ADMIN_V}.tar.gz
	mirror://npm/git-utils/-/git-utils-5.7.1.tgz -> atomdep-git-utils-${GIT_UTILS_V}.tar.gz
	mirror://npm/keyboard-layout/-/keyboard-layout-2.0.16.tgz -> atomdep-keyboard-layout-${KEYBOARD_LAYOUT_V}.tar.gz
	mirror://npm/keytar/-/keytar-6.0.1.tgz -> atomdep-keytar-${KEYTAR_V}.tar.gz
	mirror://npm/npm/-/npm-6.14.16.tgz -> atomdep-npm-${NPM_V}.tar.gz
	mirror://npm/npm-lifecycle/-/npm-lifecycle-3.1.5.tgz -> atomdep-npm-lifecycle-${NPM_LIFECYCLE_V}.tar.gz
	mirror://npm/nslog/-/nslog-3.2.0.tgz -> atomdep-nslog-${NSLOG_V}.tar.gz
	mirror://npm/oniguruma/-/oniguruma-7.2.1.tgz -> atomdep-oniguruma-${ONIGURUMA_V}.tar.gz
	mirror://npm/pathwatcher/-/pathwatcher-8.1.2.tgz -> atomdep-pathwatcher-${PATHWATCHER_V}.tar.gz
	mirror://npm/scrollbar-style/-/scrollbar-style-4.0.1.tgz -> atomdep-scrollbar-style-${SCROLLBAR_STYLE_V}.tar.gz
	mirror://npm/spellchecker/-/spellchecker-3.7.1.tgz -> atomdep-spellchecker-${SPELLCHECKER_V}.tar.gz
	mirror://npm/superstring/-/superstring-2.4.4.tgz -> atomdep-superstring-${SUPERSTRING_V}.tar.gz
	mirror://npm/tree-sitter/-/tree-sitter-0.17.1.tgz -> atomdep-tree-sitter-${TREE_SITTER_V}.tar.gz
	mirror://npm/tree-sitter-bash/-/tree-sitter-bash-0.16.1.tgz -> atomdep-tree-sitter-bash-${TREE_SITTER_BASH_V}.tar.gz
	mirror://npm/tree-sitter-c/-/tree-sitter-c-0.15.3.tgz -> atomdep-tree-sitter-c-${TREE_SITTER_C_V}.tar.gz
	mirror://npm/tree-sitter-cpp/-/tree-sitter-cpp-0.15.1.tgz -> atomdep-tree-sitter-cpp-${TREE_SITTER_CPP_V}.tar.gz
	mirror://npm/tree-sitter-css/-/tree-sitter-css-0.15.0.tgz -> atomdep-tree-sitter-css-${TREE_SITTER_CSS_V}.tar.gz
	mirror://npm/tree-sitter-embedded-template/-/tree-sitter-embedded-template-0.15.2.tgz -> atomdep-tree-sitter-embedded-template-${TREE_SITTER_EMBEDDED_TEMPLATE_V}.tar.gz
	mirror://npm/tree-sitter-go/-/tree-sitter-go-0.15.1.tgz -> atomdep-tree-sitter-go-${TREE_SITTER_GO_V}.tar.gz
	mirror://npm/tree-sitter-html/-/tree-sitter-html-0.15.1.tgz -> atomdep-tree-sitter-html-${TREE_SITTER_HTML_V}.tar.gz
	mirror://npm/tree-sitter-java-dev/-/tree-sitter-java-dev-0.16.0-dev2.tgz -> atomdep-tree-sitter-java-dev-${TREE_SITTER_JAVA_DEV_V}.tar.gz
	mirror://npm/tree-sitter-javascript/-/tree-sitter-javascript-0.15.2.tgz -> atomdep-tree-sitter-javascript-${TREE_SITTER_JAVASCRIPT_V}.tar.gz
	mirror://npm/tree-sitter-jsdoc/-/tree-sitter-jsdoc-0.15.2.tgz -> atomdep-tree-sitter-jsdoc-${TREE_SITTER_JSDOC_V}.tar.gz
	mirror://npm/tree-sitter-json/-/tree-sitter-json-0.15.1.tgz -> atomdep-tree-sitter-json-${TREE_SITTER_JSON_V}.tar.gz
	mirror://npm/tree-sitter-python/-/tree-sitter-python-0.17.1.tgz -> atomdep-tree-sitter-python-${TREE_SITTER_PYTHON_V}.tar.gz
	mirror://npm/tree-sitter-regex/-/tree-sitter-regex-0.15.1.tgz -> atomdep-tree-sitter-regex-${TREE_SITTER_REGEX_V}.tar.gz
	mirror://npm/tree-sitter-ruby/-/tree-sitter-ruby-0.15.3.tgz -> atomdep-tree-sitter-ruby-${TREE_SITTER_RUBY_V}.tar.gz
	mirror://npm/tree-sitter-typescript/-/tree-sitter-typescript-0.16.3.tgz -> atomdep-tree-sitter-typescript-${TREE_SITTER_TYPESCRIPT_V}.tar.gz
"
